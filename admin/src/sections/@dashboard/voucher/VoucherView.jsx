              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { voucher_id, code, discount_value, start_date, end_date, max_usage, current_usage, deleted_at } = row;
                    ...
                    return (
                      <TableRow hover key={voucher_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell align="left">
                          {
                            deleted_at ? <Label color={"error"}>{sentenceCase("Deleted")}</Label>
                              : <Label color={(parse(end_date, "MM dd yyyy", new Date()) > new Date() && "success") || "error"}>{sentenceCase("Active")}</Label>
                          }
